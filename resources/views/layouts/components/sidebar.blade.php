<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="#" target="_blank">
            ...
            <span class="ms-1 font-weight-bold">Wiseco.id</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link @if (request()->routeIs('inventory.*')) active @endif" href="{{ route('inventory.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link @if (request()->routeIs('pengelolaan-kas.*')) active @endif" href="{{ route('pengelolaan-kas.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Pengelolaan Kas</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#data-lainnya-dropdown" class="nav-link collapsed" aria-controls="data-lainnya-dropdown" role="button" aria-expanded="false">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#account-menu-dropdown" class="nav-link collapsed" aria-controls="account-menu-dropdown" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                        <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>settings</title>
                            <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <div class="collapse" id="account-menu-dropdown" style="">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            <a class="nav-link " href="{{ route('list-company') }}">
                                <span class="sidenav-mini-icon"> O </span>
                                <span class="sidenav-normal"> Switch Company </span>
                            </a>
                        </li>
                        <li class="nav-item ">
