<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link @if (request()->routeIs('pembelian.*')) active @endif"
            ...
            <li class="nav-item">
                <a class="nav-link @if (request()->routeIs('laporan.*')) active @endif"
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#data-lainnya-dropdown" class="nav-link collapsed"
                    aria-controls="data-lainnya-dropdown" role="button" aria-expanded="false">
                    <div
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#account-menu-dropdown" class="nav-link collapsed"
                    aria-controls="account-menu-dropdown" role="button" aria-expanded="false">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                        <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
