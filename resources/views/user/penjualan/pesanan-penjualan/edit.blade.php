...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/edit-pemesanan-penjualan.js') }}"></script>
@endpush
<x-template-layout>
                                        ...
                                        <select name="pelanggan_id" id="data_contact_id"
                                            ...
                                            @foreach ($dataContacts as $contact)
                                                <option value="{{ $contact->id }}"
                                                    @if ($data->pelanggan_id == $contact->id) selected @endif>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ $data->tanggal}}" placeholder="Nomor Telepon"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control @error('no_pesanan') is-invalid @enderror"
                                            id="invoice" name="no_pesanan" value="{{ $data->no_pesanan }}"
                                    ...
                                    <div class="col-md-12 mt-2">
                                        ...
                                        <div class="d-grid gap-3">
                                            <button class="btn bg-gradient-secondary hidden" type="button" id="addRow">
                                                <i class="fas fa-plus"></i> Add New Row
                                            </button>
                                            <div id="loader" class="lds-dual-ring overlay">
                                        </div>
                                        <hr>
                                    </div>
                                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="form-grup row mb-2">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="number" class="form-control" id="other-cost" placeholder="Rp." value="{{ $data->other_cost ?? 0 }}" min="-1" name="other_cost">
                                                </div>
                                            </div>
                                            <div class="form-grup row mb-2">
                                                <label class="col-form-label col-6 col-md-4" for="discount">Discount (%)</label>
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="number" class="form-control" id="discount" placeholder="%" value="{{ $data->discount ?? 0 }}" min="-1" name="discount">
                                                </div>
                                            </div>
                                            <div class="form-grup row mb-2">
                                                <label class="col-form-label col-6 col-md-4" for="pajak">Pajak (Rp)</label>
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="number" class="form-control" id="pajak" placeholder="Rp." value="{{ $data->pajak ?? 0 }}" min="-1" name="pajak">
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="form-grup row mb-2">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <input readonly type="text" class="form-control" id="potongan" placeholder="Rp." name="potongan" value="{{ $data->potongan ?? 0 }}">
                                                </div>
                                            </div>
                                            <div class="form-grup row mb-2">
                                                <label class="col-form-label col-6 col-md-4" for="jml-total">Total</label>
                                                <div class="col-sm-12 col-md-7">
                                                    <input readonly type="text" class="form-control" id="jml-total" placeholder="Rp." name="nilai" value="{{ $data->nilai ?? 0 }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
