...
{{-- --------------------------------------- --}}
            ...
            <div class="row">
                <a class="link  " href="{{ route('penjualan.penawaran-harga.index') }}">
            ...
            <div class="col-md-4 mt-4">
                <a class="link  " href="{{ route('penjualan.penjualan.index') }}"> 
                    <div class="card bg-cover text-center" style="background-color: #7be734">
                        <div class="card-body py-4">
                          <h4 class="text-black">Penjualan</h4>
                            <svg width="120px" height="120px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" aria-labelledby="title"
                            aria-describedby="desc" role="img" xmlns:xlink="http://www.w3.org/1999/xlink">
