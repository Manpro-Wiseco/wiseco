...
@endpush
@push('scripts')
    <script src="{{ asset('assets/js/retur-pembelian-table-edit.js') }}"></script>
    <script>
                    ...
                    <div class="card-header pb-0">
                        ...
                        <div class="card-body pt-0">
                            <form>
                                ...
                                <div class="mt-4">
                                    <input type="button" id="bt" data-id="{{ $data->id }}" value="Submit" class="btn bg-gradient-primary" />
