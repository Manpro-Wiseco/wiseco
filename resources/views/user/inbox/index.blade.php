<x-template-layout>
    <section class="content">
        ...
        @endpush
        <a href="{{ route('dashboard') }}" class="btn bg-gradient-primary">
            <i class="fas fa-angle-left" style="font-size: 20px"></i>
        </a>
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-1ycn6IcaQQ40/MKBW2W4Rhis/DbILU74C1vSrLJxCq57o941Ym01SwNsOMqvEBFlcgUa6xLiPY/NS5R+E6ztJQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />
        <link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
        <div id="card" class="card">
            <div id="chat-box" class="chat-box card p-6 m-4 custom-scrollbar w3-animate-opacity" style="overflow-y:auto; color:black;height: 600px; background-color: rgba(173,173, 173, .7)">
