...
<x-template-layout>
                                            ...
                                            <div class="d-flex px-3 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <button class="btn btn-default btn-sm mb-0 text-sm"
                                                        ...
                                                        data-bs-target="#modal-pesanan-penjualan">Laporan Pesanan
                                                        Penjualan</button>
                                                </div>
                                            </div>
                                        </td>
    ...
    <div class="modal fade" id="modal-pesanan-penjualan" tabindex="-1" role="dialog"
        aria-labelledby="modal-pesanan-penjualanLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-pesanan-penjualanLabel">Pesanan Penjualan</h5>
                    <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('laporan.penjualan.pesanan') }}" method="POST" target="_blank">
                    @csrf
