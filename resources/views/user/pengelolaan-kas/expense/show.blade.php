                                            ...
                                            <div class="row justify-content-between">
                                                ...
                                                <div class="col-lg-3 col-md-7 text-md-end text-start">
                                                    <h6 class="d-block mb-0">Kepada : <br>
                                                        {{ $expense->dataContact->name }}</h6>
                                                    <p class="">{{ $expense->dataContact->address }}
                                                    </p>
                                                    <p class="d-block text-secondary">Telepon:
                                                        {{ $expense->dataContact->phone }}
                                                    </p>
                                                </div>
                                            </div>
                                            <br>
                                            <div class="row justify-content-md-between">
                                                ...
                                                <div class="col-lg-5 col-md-7 mt-auto">
                                                    ...
                                                    <div class="row text-md-end text-start">
                                                        ...
                                                        <div class="col-md-6">
                                                            <h6 class="text-dark mb-0">
                                                                {{ \Carbon\Carbon::parse($expense->created_at)->format('d F Y h:i:s') }}
                                                            </h6>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="table-responsive">
                                                        <table class="table text-right">
                                                            ...
                                                            <tbody>
                                                                @foreach ($expense->dataAccounts as $account)
                                                                    <tr>
                                                                        <td class="text-start">
                                                                            {{ $account->name }}</td>
                                                                        <td class="ps-4">
