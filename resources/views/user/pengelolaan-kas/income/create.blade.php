...
@push('scripts')
    <script src="{{ asset('assets/js/income-table-create.js') }}"></script>
    <script>
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        ...
                        <h3>Buat Data Uang Masuk</h3>
                        <div class="card-body pt-0">
                            <form action="{{ route('pengelolaan-kas.income.store') }}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label">Ke Akun Kas</label>
