                ...
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <div class="d-flex gap-2">
                            ...
                            <h4>Detail Data Transfer Dana</h4>
                        </div>
                                            ...
                                            <div class="row justify-content-md-between">
                                                ...
                                                <div class="col-lg-5 col-md-7 mt-auto">
                                                    <div class="row mt-md-5 mt-4 text-md-end text-start">
                                                        ...
                                                        <div class="col-md-6">
                                                            <h6 class="text-dark mb-0">
                                                                {{ \Carbon\Carbon::parse($fundTransfer->transaction_date)->format('d F Y') }}
                                                            </h6>
                                                        </div>
                                                    </div>
                                                    <div class="row text-md-end text-start">
                                                        ...
                                                        <div class="col-md-6">
                                                            <h6 class="text-dark mb-0">
                                                                {{ \Carbon\Carbon::parse($fundTransfer->created_at)->format('d F Y h:i:s') }}
                                                            </h6>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table text-right">
                                                            <thead class="bg-default">
                                                                <tr>
                                                                    <th scope="col" class="pe-2 text-start ps-2">Dari
                                                                        Akun
                                                                    </th>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="text-start">
                                                                        {{ $fundTransfer->fromDataAccounts->name }}
                                                                    </td>
                                                                    <td class="text-start">
                                                                        {{ $fundTransfer->toDataAccounts->name }}</td>
                                                                    <td class="ps-4">
                                                                        {{ 'Rp ' . number_format($fundTransfer->total, 2, ',', '.') }}
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                            <tfoot>
                                                                <tr>
                                                                    <th></th>
                                                                    <th colspan="1" class="h5 ps-4">Total</th>
