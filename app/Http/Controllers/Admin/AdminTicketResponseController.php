...
class AdminTicketResponseController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.ticket.view',$request->ticket_id);
    }
    ...
    public function destroy($id)
    {
        ...
        $response->delete();
        return redirect()->route('admin.ticket.view',$data_id);
    }
}
